...
byte x16_loader[] = {0x01,0x08,0x0b,0x08,0x20,0x03,0x9e,'2','0','6','1',0,0,0};
...
//this is gross, but 0xfc is a NOP even on assemblers that accept 'illegal' ops
//unfortunately 0xff was used before which is now a legal opcode for 65c02
byte brk[]={0x00,IMM,0x00,ZP,0x00,IMP,0xfc};
byte ora[]={0x09,IMM,0x01,INDX,0x11,INDY,0x15,ZPX,0x1d,ABSX,0x19,ABSY,0x05,ZP,0x0d,ABS,0x12,ZPIND,0xfc};
byte asl[]={0x0a,ACC,0x16,ZPX,0x1e,ABSX,0x06,ZP,0x0e,ABS,0x0a,IMP,0xfc};
byte php[]={0x08,IMP,0xfc};
byte bpl[]={0x10,REL,0xfc};
byte clc[]={0x18,IMP,0xfc};
byte jsr[]={0x20,ABS,0xfc};
byte and[]={0x29,IMM,0x21,INDX,0x31,INDY,0x35,ZPX,0x3d,ABSX,0x39,ABSY,0x25,ZP,0x2d,ABS,0x32,ZPIND,0xfc};
byte bit[]={0x24,ZP,0x2c,ABS,0x89,IMM,0x34,ZPX,0x3c,ABSX,0xfc};
byte rol[]={0x2a,ACC,0x36,ZPX,0x3e,ABSX,0x26,ZP,0x2e,ABS,0x2a,IMP,0xfc};
byte plp[]={0x28,IMP,0xfc};
byte bmi[]={0x30,REL,0xfc};
byte sec[]={0x38,IMP,0xfc};
byte rti[]={0x40,IMP,0xfc};
byte eor[]={0x49,IMM,0x41,INDX,0x51,INDY,0x55,ZPX,0x5d,ABSX,0x59,ABSY,0x45,ZP,0x4d,ABS,0x52,ZPIND,0xfc};
byte lsr[]={0x4a,ACC,0x56,ZPX,0x5e,ABSX,0x46,ZP,0x4e,ABS,0x4a,IMP,0xfc};
byte pha[]={0x48,IMP,0xfc};
byte jmp[]={0x6c,IND,0x4c,ABS,0x7c,ABSIND,0xfc};
byte bvc[]={0x50,REL,0xfc};
byte cli[]={0x58,IMP,0xfc};
byte rts[]={0x60,IMP,0xfc};
byte adc[]={0x69,IMM,0x61,INDX,0x71,INDY,0x75,ZPX,0x7d,ABSX,0x79,ABSY,0x65,ZP,0x6d,ABS,0x72,ZPIND,0xfc};
byte ror[]={0x6a,ACC,0x76,ZPX,0x7e,ABSX,0x66,ZP,0x6e,ABS,0x6a,IMP,0xfc};
byte pla[]={0x68,IMP,0xfc};
byte bvs[]={0x70,REL,0xfc};
byte sei[]={0x78,IMP,0xfc};
byte sta[]={0x81,INDX,0x91,INDY,0x95,ZPX,0x9d,ABSX,0x99,ABSY,0x85,ZP,0x8d,ABS,0x92,ZPIND,0xfc};
byte sty[]={0x94,ZPX,0x84,ZP,0x8c,ABS,0xfc};
byte stx[]={0x96,ZPY,0x86,ZP,0x8e,ABS,0xfc};
byte dey[]={0x88,IMP,0xfc};
byte txa[]={0x8a,IMP,0xfc};
byte bcc[]={0x90,REL,0xfc};
byte tya[]={0x98,IMP,0xfc};
byte txs[]={0x9a,IMP,0xfc};
byte ldy[]={0xa0,IMM,0xb4,ZPX,0xbc,ABSX,0xa4,ZP,0xac,ABS,0xfc};
byte lda[]={0xa9,IMM,0xa1,INDX,0xb1,INDY,0xb5,ZPX,0xbd,ABSX,0xb9,ABSY,0xa5,ZP,0xad,ABS,0xb2,ZPIND,0xfc};
byte ldx[]={0xa2,IMM,0xb6,ZPY,0xbe,ABSY,0xa6,ZP,0xae,ABS,0xfc};
byte tay[]={0xa8,IMP,0xfc};
byte tax[]={0xaa,IMP,0xfc};
byte bcs[]={0xb0,REL,0xfc};
byte clv[]={0xb8,IMP,0xfc};
byte tsx[]={0xba,IMP,0xfc};
byte cpy[]={0xc0,IMM,0xc4,ZP,0xcc,ABS,0xfc};
byte cmp[]={0xc9,IMM,0xc1,INDX,0xd1,INDY,0xd5,ZPX,0xdd,ABSX,0xd9,ABSY,0xc5,ZP,0xcd,ABS,0xd2,ZPIND,0xfc};
byte dec[]={0x3a,ACC,0xd6,ZPX,0xde,ABSX,0xc6,ZP,0xce,ABS,0xfc};
byte iny[]={0xc8,IMP,0xfc};
byte dex[]={0xca,IMP,0xfc};
byte bne[]={0xd0,REL,0xfc};
byte cld[]={0xd8,IMP,0xfc};
byte cpx[]={0xe0,IMM,0xe4,ZP,0xec,ABS,0xfc};
byte sbc[]={0xe9,IMM,0xe1,INDX,0xf1,INDY,0xf5,ZPX,0xfd,ABSX,0xf9,ABSY,0xe5,ZP,0xed,ABS,0xf2,ZPIND,0xfc};
byte inc[]={0x1a,ACC,0xf6,ZPX,0xfe,ABSX,0xe6,ZP,0xee,ABS,0xfc};
byte inx[]={0xe8,IMP,0xfc};
byte nop[]={0xea,IMP,0xfc};
byte beq[]={0xf0,REL,0xfc};
byte sed[]={0xf8,IMP,0xfc};

//65C02 instructions
byte ina[]={0x1a,IMP,0xfc};
byte dea[]={0x3a,IMP,0xfc};
byte phx[]={0xda,IMP,0xfc};
byte plx[]={0xfa,IMP,0xfc};
byte phy[]={0x5a,IMP,0xfc};
byte ply[]={0x7a,IMP,0xfc};
byte stz[]={0x64,ZP,0x74,ZPX,0x9c,ABS,0x9e,ABSX,0xfc};
byte trb[]={0x14,ZP,0x1c,ABS,0xfc};
byte tsb[]={0x04,ZP,0x0c,ABS,0xfc};
byte bra[]={0x80,REL,0xfc};
//WDC 65C02S instructions
byte bbr0[]={0x0f,ZPREL,0xfc};
byte bbr1[]={0x1f,ZPREL,0xfc};
byte bbr2[]={0x2f,ZPREL,0xfc};
byte bbr3[]={0x3f,ZPREL,0xfc};
byte bbr4[]={0x4f,ZPREL,0xfc};
byte bbr5[]={0x5f,ZPREL,0xfc};
byte bbr6[]={0x6f,ZPREL,0xfc};
byte bbr7[]={0x7f,ZPREL,0xfc};
byte bbs0[]={0x8f,ZPREL,0xfc};
byte bbs1[]={0x9f,ZPREL,0xfc};
byte bbs2[]={0xaf,ZPREL,0xfc};
byte bbs3[]={0xbf,ZPREL,0xfc};
byte bbs4[]={0xcf,ZPREL,0xfc};
byte bbs5[]={0xdf,ZPREL,0xfc};
byte bbs6[]={0xef,ZPREL,0xfc};
byte bbs7[]={0xff,ZPREL,0xfc};
byte rmb0[]={0x07,ZP,0xfc};
byte rmb1[]={0x17,ZP,0xfc};
byte rmb2[]={0x27,ZP,0xfc};
byte rmb3[]={0x37,ZP,0xfc};
byte rmb4[]={0x47,ZP,0xfc};
byte rmb5[]={0x57,ZP,0xfc};
byte rmb6[]={0x67,ZP,0xfc};
byte rmb7[]={0x77,ZP,0xfc};
byte smb0[]={0x87,ZP,0xfc};
byte smb1[]={0x97,ZP,0xfc};
byte smb2[]={0xa7,ZP,0xfc};
byte smb3[]={0xb7,ZP,0xfc};
byte smb4[]={0xc7,ZP,0xfc};
byte smb5[]={0xd7,ZP,0xfc};
byte smb6[]={0xe7,ZP,0xfc};
byte smb7[]={0xf7,ZP,0xfc};
byte stp[]={0xdb,IMP,0xfc};
byte dbg[]={0xdb,IMP,0xfc};
byte wai[]={0xcb,IMP,0xfc};
...
void opcode(label *id, char **next) {
	...
	for(op=(byte*)(*id).line;*op!=0xfc;op+=2) {//loop through all addressing modes for this instruction
